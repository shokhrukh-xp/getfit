...
async function поднять(page, o) {
  ...
  await page.route('**/getfit-sync.sh-pulatov.workers.dev/**', async route => {
    ...
    if (p === '/dishes') {
      const б = [
        { n: 'Плов с говядиной', g: 350, k: 192, p: 7.6, c: 0.8, kp: 673, pp: 27, cp: 2.7, 'кух': 'узбекская', 'осн': 'говядина', 'точно': 1, 'ттк': 'ТТК3054', url: 'https://tekhnolog.com/x' },
        { n: 'Роллы с лососем, 6 шт', g: 200, k: 158, p: 8.4, c: 0.3, kp: 317, pp: 17, cp: 0.6, 'кух': 'японская', 'осн': 'рыба', 'точно': 1, 'ттк': 'ТТК6296', url: 'https://tekhnolog.com/y' },
        { n: 'Паста карбонара', g: 350, k: 205, p: 9.1, c: 0.5, kp: 717, pp: 32, cp: 1.6, 'кух': 'итальянская', 'осн': 'тесто', 'точно': 0, 'ттк': null, url: null },
        { n: 'Бибимбап с говядиной', g: 450, k: 133, p: 8.2, c: 1.1, kp: 600, pp: 37, cp: 5, 'кух': 'корейская', 'осн': 'говядина', 'точно': 0, 'ттк': null, url: null },
        { n: 'Шницель куриный', g: 180, k: 231, p: 17, c: 0.5, kp: 416, pp: 31, cp: 0.9, 'кух': 'европейская', 'осн': 'курица', 'точно': 0, 'ттк': null, url: null }
      ];
      return дать({ ok: true, v: 'test-1',
        'кухни': ['европейская', 'итальянская', 'корейская', 'узбекская', 'японская'],
        'основы': ['говядина', 'курица', 'рыба', 'тесто'],
        'блюда': б });
    }
    ...
    if (p === '/eat') {
      ...
      const было = [
        { id: 'm1', kind: 'ужин', text: 'Творог, яйца, греческий йогурт и банан', kcal: 482, prot: 56, fib: 3 },
        { id: 'm2', kind: 'ужин', text: 'Куриное филе на гриле с капустным салатом', kcal: 372, prot: 58, fib: 3 },
        { id: 'm3', kind: 'обед', text: 'Кукси с говядиной и овощами', kcal: 540, prot: 32, fib: 5 },
        { id: 'm4', kind: 'ужин', text: 'Плов с говядиной полпорции, салат, лепёшка', kcal: 612, prot: 21, fib: 5 },
        { id: 'm5', kind: 'перекус', text: 'Exponenta High-Pro, 2 шт · 320 г', kcal: 198, prot: 40, fib: 0 }
      ];
      return дать({ ok: true, тип: 'ужин', впереди: 1, пусто: false, всё: false,
        ост: { kcal: 517, prot: 53, fib: 7 }, цель: { kcal: 517, prot: 53, fib: 7 },
        норма: { kcal: 1750, prot: 160, fib: 20 }, съел: { kcal: 1233, prot: 107, fib: 13 },
        варианты: было.slice(0, 3).map(v => Object.assign({}, v, {
          как: v.kcal > 557 ? 'перебор ' + (v.kcal - 517) + ' ккал, белка не хватит ' + (53 - v.prot) + ' г.'
             : (v.prot >= 53 ? 'в калории попадает, белок закрывает целиком, клетчатки не хватит 4 г.'
                             : 'в калории попадает, белка не хватит ' + (53 - v.prot) + ' г.') })),
        примерка: было });
    }
    if (p === '/srez') {
